...
if request then
    ...
    lib.Message.New(request2 and "This script only works in tier 1 - 8 bank! Make sure to remove your bank members or else theres gonna be an error.");
    return;
end
